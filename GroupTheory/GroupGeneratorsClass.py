...
class C6vGenerator:
  def __init__(self, c6: sp.Matrix, s_v1: sp.Matrix, s_d1: sp.Matrix):
    ...
    self.chiTabDict = {
      r"$A_1$": {"E": sp.S(1), "2C_6": sp.S(1), "2C_3": sp.S(1), "C_2": sp.S(1), "3s_v": sp.S(1), "3s_d": sp.S(1)},
  ...
  def getOperationsDict(self) -> dict[str, list[sp.Matrix]]:
    ...
    return {
      ...
      "2C_3": [c3, c3_inv],
      "C_2": [c2],
      "3s_v": [self.s_v1, s_v2, s_v3],
      "3s_d": [self.s_d1, s_d2, s_d3],
    }
...
class C3vGenerator:
  def __init__(self, c3: sp.Matrix, s_v1: sp.Matrix):
    ...
    self.chiTabDict = {
      "A_1": {"E": sp.S(1), "2C_3": sp.S(1), "3s_v": sp.S(1)},
