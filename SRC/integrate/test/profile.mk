...
TARGET := ./local_integrand_profiling
GIT_ROOT := $(shell git rev-parse --show-toplevel)
SRC_DIR := $(GIT_ROOT)/SRC
OBJ_DIR := OBJ
MOD_DIR := MOD

SRCS := $(SRC_DIR)/integrate/src/integrate.f90 \
				...
				$(SRC_DIR)/integrate/test/test_profiling.f90
...
clean:
	$(RM) -rf *.o *.mod *.a $(OBJ_DIR) $(MOD_DIR) local_integrand_profiling *.optrpt

profile: $(TARGET)

run:
	./local_integrand_profiling
...
include $(SRC_DIR)/integrate/src/deps.mk