        ...
        DO i = -k1_steps,k1_steps
            ...
            DO j = -MIN(k1_steps - i, k1_steps), MIN(k1_steps + i, k1_steps) !This guarantees integrating over first Brillouin zone
                ...
                DO n = 1, DIM_POSITIVE_K
                    Hamiltonian(n,n) = Hamiltonian(n,n) - 0.*t_D
                    Hamiltonian(DIM_POSITIVE_K + n, DIM_POSITIVE_K + n) = Hamiltonian(n,n) + 0.*t_D 
                END DO
    ...
    DO n = 1, DIM
        DO i = -k1_steps,k1_steps
            ...
            DO j = -MIN(k1_steps - i, k1_steps), MIN(k1_steps + i, k1_steps)
                ...
                WRITE(9,*) i*dk1/SQRT(3.) * A_TILDE, (-i*dk1/3. + 2./3.*j*dk2) * A_TILDE, au_to_meV(Energies(i, j, n))*1e-3
            END DO
        END DO
        WRITE(9,*)
        WRITE(9,*)
