...
class GammaAndFillingPlotter(SymmetryResolver):
    ...
    def __init__(
        ...
        SymmetryResolver.__init__(
            self, nNeighbors, nNextNeighbors, runsPath, matchPattern, sublattices
        )
    ...
    def plotGammasJ(self):
        ...
        for key in self.symmetryKeys:
            ...
            plt.xlabel(r"$J$ (meV)")
            plt.ylabel(
                rf"$\Gamma_{{{self.latticeNameMapping[sublat - 1]} {self.latticeNameMapping[sublat % 2]},{self.orbitalNameMapping[orbital - 1]},{symmetry}}}^{{{self.spinSymbolsMapping[spin - 1]} {self.spinSymbolsMapping[spin % 2]}}}$ (meV)",
                labelpad=20,
            )
            # plt.grid()
            plt.ylim(0, 0.2)
            plt.savefig(
                f"../Plots/GammaJ_{spin}_{sublat}_{self.orbitalNameMapping[orbital - 1]}_{symmetry}.png"
            )
            plt.close()
    ...
    def plotGammasFermi(self):
        ...
        for key in self.symmetryKeys:
            ...
            plt.savefig(
                f"../Plots/GammaFermi_{spin}_{sublat}_{self.orbitalNameMapping[orbital - 1]}_{symmetry}.png"
            )
            plt.close()
    ...
    def plotGammasFilling(self):
        ...
        for key in self.symmetryKeys:
            ...
            # plt.xlim(0 , 0.1)
            plt.savefig(
                f"../Plots/GammaFilling_{spin}_{sublat}_{self.orbitalNameMapping[orbital - 1]}_{symmetry}.png"
            )
            plt.close()
    ...
    def plotGammasTemperatureMap(self):
        ...
        for key in self.symmetryKeys:
            ...
            for secondParam in secondParamValues:
                ...
                plt.ylabel(rf"T (K)")
                plt.colorbar(
                    label=rf"$\Gamma_{{{self.latticeNameMapping[sublat - 1]} {self.latticeNameMapping[sublat % 2]},{self.orbitalNameMapping[orbital - 1]},{symmetry}}}^{{{self.spinSymbolsMapping[spin - 1]} {self.spinSymbolsMapping[spin % 2]}}}$ (meV)"
                )
    ...
    def plotNnnGammasFilling(self):
        ...
        for key in self.nnnSymmetryKeys:
            ...
            plt.xlabel(r"$n_{tot}$")
            plt.ylabel(
                rf"$\Gamma_{{{self.latticeNameMapping[sublat - 1]} {self.latticeNameMapping[sublat - 1]},{self.orbitalNameMapping[orbital - 1]},{symmetry}}}^{{{self.spinSymbolsMapping[spin - 1]} {self.spinSymbolsMapping[spin % 2]}}}$ (meV)"
            )
            plt.ylim(top=1.02 * self.maxval)
            # plt.grid()
            # plt.xlim(0 , 0.1)
